...
ActiveRecord::Schema[7.0].define(version: 2023_12_10_095335) do
  ...
  create_table "question_similar_words", id: :bigint, default: -> { "nextval('questin_similar_words_id_seq'::regclass)" }, force: :cascade do |t|
